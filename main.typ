...
#show: resume.with(
  ...
  email: "austin@austinsahnow.net",
  phone: "(541) 852" + strong($dash.en$) + "2271",
  // personal-site: "austinsahnow.net",
  accent-color: "#554383",
)

Conscientious and motivated accounting student with hands-on experience from a comprehensive internship. Proficient in financial reporting, data analysis, & GAAP principles and adept with IT tools. Keen to leverage analytical skills and practical knowledge in an accounting role.
